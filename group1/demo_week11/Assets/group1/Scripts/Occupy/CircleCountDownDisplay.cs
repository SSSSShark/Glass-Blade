...
namespace Com.Glassblade.Group1
{
    public class CircleCountDownDisplay : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (viewPos.x > 80 && viewPos.x < 1840 && viewPos.y > 80 && viewPos.y < 1000)
            {
                viewPos.z = 0;
                CircleCountDown.position = viewPos;
            }
            //modified bi Via Cytus
            // 点在左边界
            else if ((-viewPos.x + 960) * 1080 > (viewPos.y - 540) * 1920 && (-viewPos.x + 960) * 1080 > (-viewPos.y + 540) * 1920)
            {
                if (viewPos.z > 0)
                {
                    viewPos.y = ((viewPos.y - 540) * 880 / (-viewPos.x + 960) + 540) > 80 ? (((viewPos.y - 540) * 880 / (-viewPos.x + 960) + 540) < 1000 ? (viewPos.y - 540) * 880 / (-viewPos.x + 960) + 540 : 1000) : 80;
                    viewPos.x = 80;
                    viewPos.z = 0;
                    CircleCountDown.position = viewPos;
                }
                ...
                {
                    viewPos.y = (-(viewPos.y - 540) * 880 / (-viewPos.x + 960) + 540) > 80 ? -(viewPos.y - 540) * 880 / (-viewPos.x + 960) + 540 : 80;
                    viewPos.x = 1840;
                    viewPos.z = 0;
                    CircleCountDown.position = viewPos;
                }
            ...
            {
                viewPos.x = ((viewPos.x - 960) * 460 / (-viewPos.y + 540) + 960) > 80 ? (viewPos.x - 960) * 460 / (-viewPos.y + 540) + 960 : 80;
                viewPos.y = 80;
                viewPos.z = 0;
                CircleCountDown.position = viewPos;
            }
