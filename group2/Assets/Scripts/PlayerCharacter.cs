...
namespace Com.GlassBlade.Group2
{
    ...
    /* 时间变量集 */
        ...
        //地雷攻击前摇时间
        public float atMineDelaytime = 1.0f;
    ...
    /* 武器集 */
        ...
        //地雷实例
        private Rigidbody mineInstance;
    ...
    /* 其它 */
        ...
        public void Attack()
        {
            ...
            if (isHoldWeapon)
            {
                switch (holdWeaponIndex)
                {
                    ...
                    //地雷
                    case 5: Invoke("AtMineAttack", atMineDelaytime); break;
                }
        ...
        /// 地雷布置
        /// </summary>
        private void AtMineAttack()
        {
            var a = Instantiate(mine, new Vector3(0, 0, 0), Quaternion.identity);
            a.transform.parent = null;
            Vector3 player_postion = this.transform.position;
            a.transform.position = player_postion + new Vector3(0, 0, 0);
            var t = a.GetComponent<Weapon5Colider>();
            t.SetHaver(this.gameObject);
        }
        ...
        public void Relive()
        {
            ...
            reliveAS.Play();
            isHoldWeapon = false;
            if(holdWeaponIndex > 0 && holdWeaponIndex < 5)
            {
                weapons[holdWeaponIndex].gameObject.SetActive(false);
            }          
            isAlive = true;
